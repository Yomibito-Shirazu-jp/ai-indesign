...
export const textFlowTools = [
    { name: 'import_text', description: 'テキストファイルを流し込む', inputSchema: { type: 'object', properties: { text: { type: 'string', description: 'テキスト内容' }, filePath: { type: 'string', description: 'ファイルパス' } }, anyOf: [{ required: ['text'] }, { required: ['filePath'] }] } },
