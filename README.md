...
**創業98年の印刷会社が、AI×日本語DTP自動化ツールをオープンソースで世界公開**
*— Adobeが長年放置した日本語縦書きDTPを、印刷現場98年の知見×AIで解決 —*

[👉 公式プレスリリースはこちら (PRESS_RELEASE.md)](PRESS_RELEASE.md)

## ひとことで言うと、何これ？
**「あなたに代わって、InDesign・Photoshop・Illustratorの3大DTPアプリを勝手に操作してくれる、見えない優秀なAIアシスタントを作り出す魔法の仕組み」**です。
文唱堂印刷株式会社が、MITライセンスで完全無償公開しました。

いつもあなたが手作業でやっていた「文字の流し込み」や「画像の配置」「PDF書き出し」「校正チェック」などを、これからはAI（Claude Desktopなど）にチャットで「A4 縦32ページ縦書き明朝体で組んで」とお願いするだけで、ソフトが自動でカチャカチャと動き出して作業を終わらせてくれます。

---

## 開発の背景と想い
**「日本の印刷市場は縮小し、人手不足。現場はDXから取り残されている」**
日本の印刷市場はこの20年間で約40%縮小し、DTPオペレーターの人手不足が深刻化しています。一方、業界標準ツールであるAdobe InDesignは、日本語縦書き組版の改善やAPI公開を長年にわたり後回しにしてきました。

文唱堂印刷は1928年の創業以来98年にわたり、日本語組版の最前線で培ってきた知見を持っています。「縮小する業界に未来を感じられなかった。だからこそ、98年の知見をAIに注入し、オープンソースで世界に公開する決断をした」。これが本プロジェクトの原点であり、Adobeの囲い込み戦略に対する**アンチテーゼ**です。
